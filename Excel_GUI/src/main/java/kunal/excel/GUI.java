...
//										System.out.println(sheet.getRow(i).getCell(j).getBooleanCellValue());
	...
	private void initialize() {
		...
		UIManager.put("OptionPane.buttonFont", new Font("Inter Medium", Font.PLAIN, 15));
		...
		txt.setFont(new Font("Inter SemiBold", Font.PLAIN, 18));
		...
		path_txt.setFont(new Font("Inter", Font.PLAIN, 16));
		...
		display_table.getTableHeader().setFont(new Font("Inter Medium", Font.PLAIN, 18));
		display_table.setFont(new Font("Inter", Font.PLAIN, 16));
		...
		display_table.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (op_txt.getText().toString() == "UPDATE") {
		...
		JMenuItem c_op = new JMenuItem("Create Excel", new ImageIcon(getClass().getResource("/resources/create.png")));
	    JMenuItem i_op = new JMenuItem("New Record", new ImageIcon(getClass().getResource("/resources/insert.png")));
	    JMenuItem u_op = new JMenuItem("Update Record", new ImageIcon(getClass().getResource("/resources/update.png")));
	    JMenuItem d_op = new JMenuItem("Delete Record", new ImageIcon(getClass().getResource("/resources/delete.png")));
	    JMenuItem up_in = new JMenuItem("Insert - Top", new ImageIcon(getClass().getResource("/resources/top.png")));
	    JMenuItem down_in = new JMenuItem("Insert - Bottom", new ImageIcon(getClass().getResource("/resources/bottom.png")));
	    JMenuItem left_in = new JMenuItem("Insert - Left", new ImageIcon(getClass().getResource("/resources/left.png")));
	    JMenuItem right_in = new JMenuItem("Insert - Right", new ImageIcon(getClass().getResource("/resources/right.png")));
	    ...
	    c_op.setFont(new Font("Inter", Font.PLAIN, 16));
	    i_op.setFont(new Font("Inter", Font.PLAIN, 16));
	    u_op.setFont(new Font("Inter", Font.PLAIN, 16));
	    d_op.setFont(new Font("Inter", Font.PLAIN, 16));
	    up_in.setFont(new Font("Inter", Font.PLAIN, 16));
	    down_in.setFont(new Font("Inter", Font.PLAIN, 16));
	    left_in.setFont(new Font("Inter", Font.PLAIN, 16));
	    right_in.setFont(new Font("Inter", Font.PLAIN, 16));
	    ...
	    c_op.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				util.createExcel(new JFileChooser().getFileSystemView().getDefaultDirectory().toString(), JOptionPane.showInputDialog(GUI.this, "File-Name", "Create Excel Sheet", JOptionPane.INFORMATION_MESSAGE));
			}
		});
	    i_op.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				expandUtil("INSERT", false);
			}
		});
	    u_op.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				expandUtil("UPDATE", true);
			}
		});
	    d_op.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				expandUtil("DELETE", false);
			}
		});
	    
	    up_in.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					
				row_index = display_table.getSelectedRow();
				
				if (row_index == -1) 
					JOptionPane.showMessageDialog(GUI.this, "NO ROW SELECTED!", "500 (Internal System Error)", JOptionPane.ERROR_MESSAGE);
	    ...
	    down_in.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		file_btn.setFont(new Font("Inter", Font.BOLD, 18));
		...
		crud_btn.setFont(new Font("Inter", Font.BOLD, 18));
		...
		op_txt.setFont(new Font("Inter SemiBold", Font.BOLD, 40));
		...
		op_btn.setFont(new Font("Inter", Font.BOLD, 18));
		...
		op_btn.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (op_txt.getText().toString() == "INSERT") {
					pop_insert.show(op_btn, e.getX(), e.getY());
				}
			}
		});
		
		op_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					if (op_txt.getText().toString() == "DELETE") {
					...
					if (op_txt.getText().toString() == "UPDATE") {
						...
						if (row_index == -1) 
							...
							util.updateRecordExcel(row_index+1, col_index, file, field.getText().toString());
							tableModel.setColumnCount(0);
							tableModel.setRowCount(0);
							tableModel.fireTableDataChanged();
							readExcel();
		...
		close_btn.setFont(new Font("Inter", Font.BOLD, 18));
